...
while run:
    ...
    for i in range(len(objectList)):     
        ...
        #Calculate the larger radius as a result of tangential movement
    ...
    pygame.draw.rect(win,redColor,pygame.Rect(sliderObjNum*10,5,10,90))
    pygame.draw.rect(win,(213,34,102),pygame.Rect(sliderBaseVel+xCen,105,10,90))
    pygame.draw.rect(win,(108,200,5),pygame.Rect(sliderFrictionCoeff,205,10,90))
